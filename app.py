...
# Function to create and display the popup message window
def popupmsg(msg):
    global camera_window_hidden
...
# Construct the argument parse and parse the arguments (TSK 574)
...
# Threshold values for eye aspect ratio (TSK 575)
EYE_AR_THRESH = 0.3
EYE_AR_CONSEC_FRAMES = 3

# Variables to track blink count
COUNTER = 0
TOTAL = 0
...
# Set eye blink threshold and initialize variables for tracking time
eye_thresh = 5
